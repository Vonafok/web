    ...
    <div class="wrapper">
        <div class="header">
            ...
            <div class="header__navigation">
                ...
                if(isset($_SESSION['name'])) 
                {
                  echo "<button class='header__button popup-link' id='exit_button'>Выход</div>";
                }
                else
                {
                  echo "<button id='auth_button' class='header__button popup-link'>Войти</button>";
                  echo "<button id='reg_button' class='header__button popup-link'>Зарегистрироваться</button>";
                }
                ?>
            ...
            <div class="popup__content">
                ...
                <div class="popup__form">
                    <form action="#" class="auth" id="auth">
                        <label for="UserMail">имя</label>
                        <input id="UserMail" name="name" class="form__input" placeholder="Иван" type="name" required>

                        <label for="UserPassword">Пароль</label>
                        <input id="UserPassword" name="password" class="form__input" placeholder="p@ssWoRD1" type="password" required>
    ...
    <div id="registration" class="popup">
        <div class="popup__body">
            <div class="popup__content">
                ...
                <div class="popup__form">
                    <form  class="registration" id="registration-form" dataset="registration-form">
                        <label for="UserName">Имя</label>
                        <input id="UserName" name="name" class="form__input" type="name" required="" placeholder="Иван" pattern="[А-Яа-яA-Za-z\s-]*" title="Используйте русские или латинские буквы">

                        <label for="UserMail">E-mail</label>
                        <input id="UserMail" name="email" class="form__input" type="email" required="" placeholder="example@gmail.com" title="Введите email">

                        <label for="UserPhone">Телефон</label>
                        <input id="UserPhone" name="telephone" class="form__input" required="" placeholder="89205108710" pattern="8\d{3}\d{3}\d{2}\d{2}" title="Введите телефон в формате 8**********">

                        <label for="UserPassword">Пароль</label>
                        <input id="UserPassword" name="password" class="form__input" type="password" placeholder="p@ssWoRD1" required="" pattern="^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{6,}$" title="Минимум 6 символов. Обязательно наличие букв и цифр">
                        ...
                        <span><input class="form__checkbox" type="checkbox" value="true" required>Я принимаю условия политики конфеденциальности</span>
